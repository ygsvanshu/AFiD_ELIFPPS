...
4. The file `/src/BoundaryConditions/MyCustomBC/BoundaryConditions.F90` can now be edited as per the requirements of the user. A brief note is provided in the comments at the top of the file on how to use the quantities available in the code to modify the file.
